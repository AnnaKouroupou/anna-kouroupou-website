        ...
        <div class="product-header">
          <div class="product-details">
            <div class="product-photos">
              ...
              <div
                v-if="$page.post.photos.length > 1"
                class="product-photos-divider"
              >
                <div></div>
              </div>
              <div class="product-current-photo">
                <g-image
            ...
            <div class="product-info">
              <h1 class="product-title" v-html="$page.post.title" />
              ...
              <div class="contact-us">
                <a
                  :href="`mailto:${settings.contact_email}?subject=I'm interested about product: ${$page.post.title}`"
                  class="button"
                  >ask me about the product</a
                >
              </div>
            </div>
          </div>
...
.product-current-photo:hover .overlay {
  cursor: pointer;
  opacity: 0.4;
}
.product-current-photo .overlay div {
  padding: 5px 10px;
}
.product-more-photos .thumbnail {
  padding: 5px;
  cursor: pointer;
  object-fit: contain;
  max-height: 100%;
}
.product-current-photo .thumbnail {
  object-fit: contain;
